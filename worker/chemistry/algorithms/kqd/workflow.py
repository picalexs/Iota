    ...
    *,
    ...
    return _KQDSolveData(
        ...
        matrix_element_summary={
            ...
            "basis_complete": basis_matrix.shape[1] >= sector_action.dimension,
            "full_space_residual_available": basis_matrix.shape[1] >= sector_action.dimension,
    ...
    *,
    ...
    return _KQDSolveData(
        ...
        matrix_element_summary={
            ...
            "basis_complete": basis_matrix.shape[1] >= operator.shape[0],
            "full_space_residual_available": basis_matrix.shape[1] >= operator.shape[0],
            "projected_matrix_element_count": 2 * basis_matrix.shape[1] ** 2,
            "time_step": kqd_config.time_step,
            "trotter_steps": kqd_config.trotter_steps,
            "residual_kind": "projected_generalized_eigenpair",
