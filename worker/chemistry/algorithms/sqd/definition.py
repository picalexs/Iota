"""Registered SQD execution entry point."""
...
def run_sqd_algorithm(
    ...
    resolved = resolve_algorithm_config(config, RunAlgorithm.SQD.value)
        ...
        progress_callback(
            {
                **payload,
                ...
                "step": "sampling_vqe",
                "reference_algorithm": RunAlgorithm.VQE.value,
